...
const serviceKeys = [
  { titleKey: "services.mysteryShopping.title", subtitleKey: "services.mysteryShopping.subtitle", descKey: "services.mysteryShopping.desc", ctaKey: "services.mysteryShopping.cta", href: "/services/jabb-app", image: "/images/screen-missions.jpg", gradient: "from-[#1E3498] to-[#2A4ABF]", phone: true, smallImage: false, fx: "fx-float", qrStand: false },
  { titleKey: "services.voiceOfCustomer.title", subtitleKey: "services.voiceOfCustomer.subtitle", descKey: "services.voiceOfCustomer.desc", ctaKey: "services.voiceOfCustomer.cta", href: "/services/voice-of-customer", image: "/images/screen-analytics.jpg", gradient: "from-[#142470] to-[#2A4ABF]", phone: false, smallImage: false, fx: "fx-shimmer", qrStand: false },
  { titleKey: "services.aiReports.title", subtitleKey: "services.aiReports.subtitle", descKey: "services.aiReports.desc", ctaKey: "services.aiReports.cta", href: "/services/voice-of-customer", image: "/images/screen-ai-report.jpg", gradient: "from-[#2A4ABF] to-[#142470]", phone: false, smallImage: false, fx: "fx-glow", qrStand: false, docFrame: true },
  { titleKey: "services.qrCodes.title", subtitleKey: "services.qrCodes.subtitle", descKey: "services.qrCodes.desc", ctaKey: "services.qrCodes.cta", href: "/services/qr-codes", image: "/images/screen-qr.jpg", gradient: "from-[#142470] to-[#1E3498]", phone: false, smallImage: true, fx: "fx-tilt", qrStand: true },
  { titleKey: "services.cxAudits.title", subtitleKey: "services.cxAudits.subtitle", descKey: "services.cxAudits.desc", ctaKey: "services.cxAudits.cta", href: "/services/cx-audits", image: "/images/screen-new-5.jpg", gradient: "from-[#1E3498] to-[#2A4ABF]", phone: false, smallImage: false, fx: "fx-reveal", qrStand: false },
] as const;
